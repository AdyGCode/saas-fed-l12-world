<x-guest-layout>
    ...
    <div class="py-12 space-y-6">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg grid grid-cols-2 space-x-6">
                <div class="p-6 text-gray-900 gap-6 flex flex-col border-r border-r-gray-300">

                    <h2 class="text-3xl">Dependant Select Boxes (Standard)</h2>

                    Because the List of Cities is so long, this is not feasible.

                </div>

                <div class="p-6 text-gray-900 gap-6 flex flex-col">
                    <h2 class="text-3xl">Dependant Select Boxes (LiveWire)</h2>

                    <livewire:country-city-select/>
